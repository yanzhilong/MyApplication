...
public class Word {
    ...
    private String british_sound; //英式发音(下面同上)
    private String american_phonogram; //英式发音音标
    private String american_sound; //美式发音
    ...
    private String transitive_verb_short = "vt.(可及物动词)"; //(vt.(可及物动词))
    ...
    public String getBritish_sound() {
        return british_sound;
    }

    public void setBritish_sound(String british_sound) {
        this.british_sound = british_sound;
    }
    ...
    public String getAmerican_sound() {
        return american_sound;
    }

    public void setAmerican_sound(String american_sound) {
        this.american_sound = american_sound;
    }
