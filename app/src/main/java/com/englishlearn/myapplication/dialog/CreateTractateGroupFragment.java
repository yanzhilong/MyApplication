 ...
 */
public class CreateTractateGroupFragment extends android.support.v4.app.DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View passwordErrorLayout = factory.inflate(R.layout.createtractategroup, null);
